...
| 6 ｜ [1014 福尔摩斯的约会 (20point(s))](https://pintia.cn/problem-sets/994805260223102976/problems/994805308755394560) | 20  [1014](https://github.com/pipo-chen/play-pat/tree/master/data-structure/1014) | C++ | 1. 注意审题：是相对位置上的字符判同 2. 先判断字符合法再判断字符是否相同 与 先判断字符是否相同再判断字符是否合法 会造成截然不同的对错判断？|